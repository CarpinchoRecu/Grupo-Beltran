        ...
        <>
            <div className="op">
                <div className="titleTrabajo">
                    <h1>
                        ¿ESTAS BUSCANDO UN TRABAJO CON BUEN AMBIENTE LABORAL Y POSIBILIDAD
                        DE CRECIMIENTO?
                    </h1>
                    <h2>¡En AsesSalud te damos esa opurtunidad!</h2>
                    <div className="circulo">
                        <h1>
                            Hace <strong>CLICK</strong> aca
                        </h1>
                        <DelayLink
                            className="linkTrabajo"
                            to="/Trabajo/FormularioTrabajo"
                            delay={310}
                        >
                            <img src={flecha} alt="flecha" />
                        </DelayLink>
                        <h2>
                            Completa el formulario para formar parte de nuestra empresa.
                        </h2>
                    </div>
                    <div className="frase">
